...
__itemdef__ = define.itemdef(
	...
	__config		= dict(
		...
		base_path	= "[default:generated]",	# [o] Normally auto-generated by define.get_itemdef_layout(), this can
												# also be a string, or a callable that receives a Request object.
	...
	category_id			= relational.ForeignSelectField(
		...
		fwhere			= 'WHERE active = 1',	# A string specifying the WHERE clause, OR
		# fwhere			= {'active':1},		# An array to use to build the WHERE clause, OR
		# fwhere			= fwhere_callback	# A callable that returns either a string or a dict
	),
